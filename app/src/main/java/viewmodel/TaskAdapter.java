...
import com.kirakn.a10.R;
import model.Task;
import view.UpdateTaskActivity;
...
public class TaskAdapter extends RecyclerView.Adapter<TaskAdapter.ViewHolder>{
    ...
    public TaskAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        @SuppressLint("ResourceType") View view = inflater.inflate(R.drawable.task_item, parent, false); // трансформация layout-файла во View-элемент
